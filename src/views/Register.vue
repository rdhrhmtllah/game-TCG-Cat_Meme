    ...
    <div class="glass-panel p-8 w-full max-w-sm animate-scale-in">
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        <div>
          ...
          <p class="text-xs text-muted mt-1">3-20 karakter, huruf, angka, underscore</p>
        </div>
        <div>
        ...
        <div>
          <label class="block text-sm font-medium text-secondary mb-1.5">Konfirmasi Password</label>
